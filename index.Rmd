...
knitr::write_bib(c(
  .packages(), 'bookdown', 'knitr', 'rmarkdown', 'palmerpenguins', 'lubridate', 'janitor', 'rstatix', 'ggsci', 'wesanderson', 'colorBlindness', 'patchwork', 'here', 'kableExtra', 'plotly', 'gitcreds', 'usethis', 'ggridges'
), 'packages.bib')
