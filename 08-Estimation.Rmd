...
<details><summary> **Click-me for answer** - If you got completely stuck, or had a go but want to check your answers then click here:</summary>
...
# Notice the argument section is blank, what happens when you try to put something in the brackets when using this function?
...
# what happens when you put a "string" in the brackets? What happens when you leave it blank?
say_morning_default()
```
...
<details><summary> **Click-me for A solution**</summary>
...
[**This is a really good intro to learning how to purrr - try some of the simple exercises here before trying the below**](https://www.rebeccabarter.com/blog/2019-08-19_purrr/)
