...
We first met `NA` back in Chapter \@ref(missing-values-na) and you will hopefully have noticed, either here or in those previous chapters, that missing values `NA` can really mess up our calculations. There are a few different ways we can deal with missing data:
...
Enjoy this stupid reward from [ggcats](https://github.com/R-CoderDotCom/ggcats)
