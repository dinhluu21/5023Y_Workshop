...
# Plotting the fitted values against the dependent e.g. our regression line
p2 <- augmented_ls1 %>% 
  ggplot(aes(x=hardness, y=.fitted))+
  geom_line()+
...
<details><summary> **CHALLENGE - the above is an example of functional, but repetitive code - could you make a function that reduces the amount of code needed? CLICK HERE for a solution**</summary>
...
augment(janka_ls1, newdata=newdata)
