...
SST <- darwin_augmented %>% ggplot(aes(x=order, y=height, colour=type))+geom_segment(aes(x=order, xend=order, y=height, yend=18.9), linetype="dashed", colour="black")+geom_point()+scale_colour_manual(values=c("darkorange", "forestgreen"))+theme_classic()+labs(y="Height in inches", x="Data ordered by type", colour="Pollination type")+geom_hline(aes(yintercept = 18.9), colour="blue")+ggtitle("Sum of Squares Total (SST)")

SSR <- darwin_augmented %>% ggplot(aes(x=order, y=height, colour=type))+geom_segment(aes(x=order, xend=order, y=18.9, yend=.fitted), linetype="dashed", colour="black")+geom_point(alpha=0.4)+scale_colour_manual(values=c("darkorange", "forestgreen"))+theme_classic()+labs(y="Height in inches", x="Data ordered by type", colour="Pollination type")+geom_hline(aes(yintercept = 18.9), colour="blue")+geom_segment(aes(x=16, xend=30, y=.fitted, yend=.fitted), colour="red")+ggtitle("Sum of Squares Regression (SSR)")+geom_segment(aes(x=1, xend=30, y=.fitted, yend=.fitted, group=type), colour="red")

SSE <- darwin_augmented %>% ggplot(aes(x=order, y=height, colour=type))+geom_segment(aes(x=order, xend=order, y=height, yend=.fitted), linetype="dashed", colour="black")+geom_point()+scale_colour_manual(values=c("darkorange", "forestgreen"))+theme_classic()+labs(y="Height in inches", x="Data ordered by type", colour="Pollination type")+geom_hline(aes(yintercept = 20.192), colour="blue")+geom_segment(aes(x=16, xend=30, y=.fitted, yend=.fitted), colour="red") +ggtitle("Sum of Squares Error (SSE)")
