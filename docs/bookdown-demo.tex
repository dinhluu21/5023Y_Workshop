...
When typed in-line within a section of what would otherwise be Markdown text, it knows to produce an r output instead 2022-03-21
...
\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-440-1.pdf}
...
\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-443-1.pdf}
...
\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-447-1.pdf}
...
\includegraphics[height=2\textheight]{bookdown-demo_files/figure-latex/unnamed-chunk-461-1}
\includegraphics[height=2\textheight]{bookdown-demo_files/figure-latex/unnamed-chunk-461-2}
\includegraphics[height=2\textheight]{bookdown-demo_files/figure-latex/unnamed-chunk-461-3}
...
\begin{figure}
\centering
\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-470-1.pdf}
...
\begin{figure}
\centering
\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-476-1.pdf}
...
\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-485-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{emmeans}\SpecialCharTok{::}\FunctionTok{emmeans}\NormalTok{(ls\_2, }\AttributeTok{specs =}\NormalTok{ pairwise }\SpecialCharTok{\textasciitilde{}}\NormalTok{ Light }\SpecialCharTok{+}\NormalTok{ Fert }\SpecialCharTok{+}\NormalTok{ Light}\SpecialCharTok{:}\NormalTok{Fert)}
\CommentTok{\# including the argument pairwise in front of the \textasciitilde{} prompts the post{-}hoc pairwise comparisons.}
 \CommentTok{\# $emmeans contains the estimate mean values for each possible combination (with confidence intervals)}
 \CommentTok{\# $ contrasts contains tukey test post hoc comparisons between levels}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-500-1.pdf}
...
\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-502-1.pdf}
...
\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-510-1.pdf}
...
\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-513-1.pdf}
...
\begin{figure}
\centering
\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-530-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# optional extras for adding animal silhouette}
\FunctionTok{library}\NormalTok{(rphylopic)}
\CommentTok{\# search for the right image in the database}
\NormalTok{fruitfly\_phylo }\OtherTok{\textless{}{-}} \FunctionTok{name\_search}\NormalTok{(}\AttributeTok{text =} \StringTok{"Drosophila melanogaster"}\NormalTok{, }\AttributeTok{options =} \StringTok{"namebankID"}\NormalTok{)[[}\DecValTok{1}\NormalTok{]] }

\CommentTok{\# name\_images(uuid = fruitfly$uid[1])}

\CommentTok{\# extract the ID of thr right image}
\NormalTok{fruitfly\_2 }\OtherTok{\textless{}{-}} \FunctionTok{name\_images}\NormalTok{(}\AttributeTok{uuid =}\NormalTok{ fruitfly\_phylo}\SpecialCharTok{$}\NormalTok{uid[}\DecValTok{1}\NormalTok{])}\SpecialCharTok{$}\NormalTok{same[[}\DecValTok{2}\NormalTok{]]}\SpecialCharTok{$}\NormalTok{ui}

\CommentTok{\# get the actual image}
\NormalTok{fruitfly\_pic }\OtherTok{\textless{}{-}} \FunctionTok{image\_data}\NormalTok{(fruitfly\_2, }\AttributeTok{size =} \DecValTok{256}\NormalTok{)[[}\DecValTok{1}\NormalTok{]]}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-543-1.pdf}
...
\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-553-1.pdf}
...
\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-558-1.pdf}
...
\includegraphics{bookdown-demo_files/figure-latex/bernplot-1.pdf}
...
\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-572-1.pdf}
...
\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-573-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{augment\_glm }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(mod, }\AttributeTok{predict =} \ConstantTok{NULL}\NormalTok{)\{}
\NormalTok{  fam }\OtherTok{\textless{}{-}} \FunctionTok{family}\NormalTok{(mod)}
\NormalTok{  ilink }\OtherTok{\textless{}{-}}\NormalTok{ fam}\SpecialCharTok{$}\NormalTok{linkinv}
  
\NormalTok{  broom}\SpecialCharTok{::}\FunctionTok{augment}\NormalTok{(mod, }\AttributeTok{newdata =}\NormalTok{ predict, }\AttributeTok{se\_fit=}\NormalTok{T)}\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{mutate}\NormalTok{(}\AttributeTok{.lower =} \FunctionTok{ilink}\NormalTok{(.fitted }\SpecialCharTok{{-}} \FloatTok{1.96}\SpecialCharTok{*}\NormalTok{.se.fit),}
           \AttributeTok{.upper =} \FunctionTok{ilink}\NormalTok{(.fitted }\SpecialCharTok{+} \FloatTok{1.96}\SpecialCharTok{*}\NormalTok{.se.fit), }
           \AttributeTok{.fitted=}\FunctionTok{ilink}\NormalTok{(.fitted))}
\NormalTok{\}}

\FunctionTok{augment\_glm}\NormalTok{(binary\_model)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-584-1.pdf}
