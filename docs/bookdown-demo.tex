...
When typed in-line within a section of what would otherwise be Markdown text, it knows to produce an r output instead 2022-01-27
...
\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-355-1.pdf}
