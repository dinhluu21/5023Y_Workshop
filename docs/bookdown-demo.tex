...
When typed in-line within a section of what would otherwise be Markdown text, it knows to produce an r output instead 2021-11-18
...
\begin{Highlighting}[]
\NormalTok{penguins }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{filter}\NormalTok{(}\FunctionTok{grepl}\NormalTok{(}\StringTok{"N1"}\NormalTok{, individual\_id)) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{distinct}\NormalTok{(individual\_id)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{penguins }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{select}\NormalTok{(date\_egg, date\_egg\_proper) }\SpecialCharTok{\%\textgreater{}\%} 
...
\begin{Highlighting}[]
\NormalTok{penguins }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{summarise}\NormalTok{(}\AttributeTok{min\_date=}\FunctionTok{min}\NormalTok{(date\_egg\_proper),}
            \AttributeTok{max\_date=}\FunctionTok{max}\NormalTok{(date\_egg\_proper))}
\end{Highlighting}
\end{Shaded}
...
As with all cool functions, you should check out the RStudio cheat sheet for more information
...
\NormalTok{penguins }\SpecialCharTok{\%\textgreater{}\%} 
  ...
  \FunctionTok{summarise}\NormalTok{(}\AttributeTok{min=}\FunctionTok{min}\NormalTok{(date\_egg\_proper), }
            \AttributeTok{max=}\FunctionTok{max}\NormalTok{(date\_egg\_proper), }
            \AttributeTok{years =}\NormalTok{ (max}\SpecialCharTok{{-}}\NormalTok{min)}\SpecialCharTok{/}\FunctionTok{dyears}\NormalTok{(}\DecValTok{1}\NormalTok{),}
