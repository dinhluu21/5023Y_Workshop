...
When typed in-line within a section of what would otherwise be Markdown text, it knows to produce an r output instead 2021-12-01
...
## 1 bill_length_~ bill_depth_~ -0.24     -4.46 0.0000112   -0.333    -0.132 Pears~
\end{verbatim}
...
## 1 Adelie   bill_len~ bill_de~  0.39      5.19 6.67e- 7    0.247     0.519 Pears~
## 2 Chinstr~ bill_len~ bill_de~  0.65      7.01 1.53e- 9    0.492     0.772 Pears~
## 3 Gentoo   bill_len~ bill_de~  0.64      9.24 1.02e-15    0.526     0.737 Pears~
\end{verbatim}
